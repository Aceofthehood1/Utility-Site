    ...
    <>
      ...
      >
        <form className="w-3/4 lg:w-2/4 flex flex-col bg-blue-500 rounded-lg justify-center items-center mt-5 mb-5">
          ...
          <input
            id="fname"
            className="text-lg lg:w-80 h-12 rounded-lg m-5"
            type="text"
          ...
          <a
            href="#"
            className="text-sm lg:ml-44 mb-4 hover:text-red-600 items-end"
          >
      ...
      <pre className="lg:bg-orange-600 p-5 rounded-lg">
        <code className="text-xs">
          <p id="clipboard">
            &lt;form className="w-3/4 lg:w-2/4 flex flex-col bg-blue-500
            rounded-lg justify-center items-center mt-5 mb-5"&gt;<br></br>
            &lt;h3 className="text-2xl lg:text-3xl m-2"&gt;Create An
            Account&lt;/h3&gt;<br></br>
            &lt;input id="fname" className="text-lg lg:w-80 h-12 rounded-lg m-5"
            type="text" placeholder="First Name"/&gt;<br></br>
            &lt;input id="lname" className="text-lg lg:w-80 h-12 rounded-lg m-5"
            type="text" placeholder="Last Name"/&gt;<br></br>
            &lt;input id="email" className="text-lg lg:w-80 h-12 rounded-lg m-5"
            type="text" placeholder="Email"/&gt;<br></br>
            &lt;input id="password" className="text-lg lg:w-80 h-12 rounded-lg
            m-5" type="text" placeholder="Password"/&gt;<br></br>
          ...
          <button
            className="p-2 bg-blue-600 w-40 h-10 rounded-lg ml-80 hover:scale-110"
